...
def game_chat_ia(con, addr):
    ...
    try:
        ...
        while True:
            ...
            con.settimeout(random.randint(20, 30))
            ...
            try:
                ...
                response = gemini_client.models.generate_content(
                    model='gemini-2.0-flash',
                    contents='Ask a casual question to start a conversation but do not repeat yourself.',
                    config=types.GenerateContentConfig(
                        system_instruction=turing_game_system_instruction,
                        max_output_tokens=400,
                        top_k=2,
...
# Other functions and server setup remain the same
